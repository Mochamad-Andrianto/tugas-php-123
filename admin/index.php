...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link" style="text-align: center;">
      <span class="brand-text font-weight-light "><b>SI</b>ADMIN</span>
    </a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="index.php?page=Alumni" class="nav-link">
                  <i class="nav-icon fa fa-user"></i>
                  <p>ALUMNI</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a href="index.php?page=navbar" class="nav-link">
            <i class="nav-icon fab fa-envira"></i>
              <p>
                NAVBAR
              </p>
  ...
  <div class="content-wrapper">
    <?php 
        ...
        }else if (@$_GET['page']=='Prestasi'){
          include 'views/Prestasi.php';
        }else if (@$_GET['page']=='Galeri'){
          include 'views/Galeri.php';
        }else if (@$_GET['page']=='navbar'){
  ...
  <?php echo "Copyright © 2021 - " . (int)date('Y'). " SMAYANDA" ?>
    All rights reserved.
